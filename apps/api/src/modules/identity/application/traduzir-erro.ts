...
/**
 * Handle já tomado é conflito de recurso (409); o resto é entrada que não
 * passa na regra de negócio (422). O 422 e não 400 porque a sintaxe estava
 * certa — o Zod da borda já teria barrado o que é malformado.
 */
